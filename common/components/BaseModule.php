...
class BaseModule extends Module implements BootstrapInterface
{
    ...
    public function registerTranslations()
    {
        ...
        Yii::$app->i18n->translations['app/modules/' . $moduleId] = [
            ...
            'sourceLanguage' => 'en',
            'basePath' => '@modules/' . $moduleId . '/messages',
...
//    {
//        return Yii::t('app/modules/' . self::$moduleId .'/'. $category, $message, $params, $language);
//    }
    ...
    public function dashboardNavItems($options = false)
    {
        $items = [
            'label' => $this->name,
            'url' => ['/'. $this->id . ((isset($this->defaultRoute)) ? '/' . $this->defaultRoute : '')],
...
//        exit;
    ...
    public function bootstrap($app)
    {
        ...
        // Add short module alias, like `@sitemap` instead of long `modules/sitemap`
        if ($this->id !== 'base') {
     ...
     * @see \modules\options\models\Options
     *
