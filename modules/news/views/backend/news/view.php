...
$bundle = false;
if ($model->locale && isset(Yii::$app->translations) && class_exists('\app\modules\translations\FlagsAsset')) {
    $bundle = \app\modules\translations\FlagsAsset::register(Yii::$app->view);
}
