...
use modules\organization\models\OrganizationTypesSearch;
use Yii;
use common\components\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;
use modules\media\models\Types;
use modules\media\models\TypesSearch;

/**
 * CatsController implements the CRUD actions for Types model.
 */
...
//        }
    ...
    {
        $searchModel = new OrganizationTypesSearch();
    ...
    {
        if (($model = OrganizationTypes::findOne($id)) !== null) {
            return $model;
        }
