...
$this->title = Yii::t('app/modules/organization', 'View category');
...
<div class="organization-cats-view">
    ...
    <div class="form-group">
        ...
        <?php if (Yii::$app->authManager  && Yii::$app->user->can('managerPosts', [
            ...
            <?= Html::a(Yii::t('app/modules/organization', 'Update'), ['cats/update', 'id' => $model->id], ['class' => 'btn btn-primary pull-right']) ?>
        <?php endif; ?>
    </div>
</div>
